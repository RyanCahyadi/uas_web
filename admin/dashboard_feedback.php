...
<html lang="en">
    <head>
        ...
        <title>Halaman dashboard feedback user</title>
            ...
            <div class="page-wrapper">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Feedback Customer</h4>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                <!-- <h4 class="card-title">Data feedback customer</h4> -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Tambah feedback customer</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="http://localhost/kampus/uts_ecommerce/admin/api/addFeedbackCustomer.php" method="POST">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <input type="email" name="email" class="form-control" placeholder="Masukan email anda . . .">
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Masukan feedback anda . . ."></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="mdi mdi-delete-circle btn-lg" data-toggle="modal" data-target="#modalDeleteFeedback<?= $row['id']; ?>"></a>
                                                </td>
                                            </tr>
