...
<html>
<head>
<title>Matrix - Belanjua sepuas mu</title>
<!-- for-mobile-apps -->
...
<body>
	<div class="header">
		<div class="container">
			<div class="logo">
				<h1 ><a href="index.html"><b>T<br>H<br>E</b>Matrix<span>Tempat belanja kita</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
	...
	<div data-vide-bg="assets/video/video">
		<div class="container">
			<div class="banner-info">
				<h3>Belanja apapun yang kalian inginkan !</h3>
			</div>	
		</div>
	</div>
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						<a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
							<img src="assets/images/of16.png" class="img-responsive" alt="">
						</a>
						<div class="mid-1">
							<div class="women">
							...
							<div class="mid-2">
								<p><em class="item_price">Rp. 60.000,00</em></p>
								<div class="block">
							...
							<div class="add add-2">
								<a href="" class="btn btn-danger my-cart-btn my-cart-b">Lihat produk</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="footer">
		<div class="container">
			<div class="footer-bottom">
				<h2 ><a href="index.html"><b>T<br>H<br>E</b>Matrix<span>Tempat belanja kita</span></a></h2>
				<p class="fo-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</p>
				<div class="copy-right">
				<p> &copy; 2016 Matrix. All Rights Reserved | Design by  <a href="http://w3layouts.com/"> W3layouts</a></p>
			</div>
		</div>
	</div>
<!-- //footer-->
